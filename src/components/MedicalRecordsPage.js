      ...
      <div className="main-container">
        ...
        <div className="sidebar">
          ...
          {["Dashboard","Recent Visits","Medical Records","Billing","Settings","Logout"].map((item) => (
            <div
              key={item}
              className={`nav-item ${item === "Medical Records" ? "active" : ""}`}
              onClick={() => {
          ...
          {showVitals && activeTab === "Current Records" && (
            <div className="vitals-display">
              <ul className="vitals-list">
                <li><strong>Blood Pressure:</strong> {vitalsData.bloodPressure}</li>
                <li><strong>Pulse Rate:</strong> {vitalsData.pulseRate}</li>
                <li><strong>Respiratory Rate:</strong> {vitalsData.respiratoryRate}</li>
                <li><strong>Temperature:</strong> {vitalsData.temperature}</li>
                <li><strong>Height:</strong> {vitalsData.height}</li>
                <li><strong>Weight:</strong> {vitalsData.weight}</li>
                <li><strong>BMI (Body Mass Index):</strong> {vitalsData.bmi}</li>
                <li><strong>SpO2 (Oxygen Saturation):</strong> {vitalsData.spO2}</li>
              </ul>
            </div>
          )}
